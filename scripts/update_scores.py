...
KALSHI_TEAM_MAP = {
    ...
    # West region
    "ARIZ": "Arizona", "ARI": "Arizona", "ARIZONA": "Arizona",
    "LIU": "Long Island", "LONG ISLAND": "Long Island",
    ...
    "MIAMI (OHIO)": "Miami (Ohio)", "MIAMI OHIO": "Miami (Ohio)",
    "MIAMI (OH)": "Miami (Ohio)",
    "SMU": "SMU",
